...
graph LR
    ...
    subgraph "GitHub Actions Pipeline (Current POC)"
        ...
        test["2. Unit + Integration Tests<br/>Vitest (892 tests, 49 files)"]
...
- GitHub Actions runs Vitest (892 tests across 49 files — 615 backend under node, 277 frontend under jsdom)
